...
public class Missile implements Collidable, Weapon {
	private Image image;
	...
	public Missile(float startX, float startY, float angle) {
		image = assetManager().getImage("images/missile.png");
	...
	public void update(float delta) {
		...
		if (elapsedLifetime > maxLifetime) {
			...
			ParticleMgr.get().spawnParticle(x, y);
		}
	}
